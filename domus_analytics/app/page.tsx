...
export default function HomePage() {
    ...
    return (
      <main className="min-h-screen bg-domus-bg flex flex-col items-center justify-center p-8">
        <div className="text-center max-w-lg">
          ...
          <p className="text-xl text-domus-textSoft mb-8">Bienvenido al Analytics Dashboard</p>
  ...
  return (
    <main className="min-h-screen bg-domus-bg flex flex-col items-center justify-center p-8">
      <div className="text-center max-w-lg">
        <h1 className="text-6xl font-bold text-domus-primary mb-4">Domus</h1>
        <p className="text-xl text-domus-textSoft mb-8">Analytics Dashboard — Visualización de métricas centralizada</p>
